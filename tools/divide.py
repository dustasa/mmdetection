...
coco = COCO('../data/coco_ori/annotations/instances_train2017.json',
            origin_img_dir='./data/coco_ori/train2017')  # 完整的coco数据集的图片和标注的路径
coco.build('./data/coco/train2017', './data/coco/instances_train2017.json', 118287)  # 保存图片路径

coco = COCO('../data/coco_ori/annotations/instances_val2017.json',
            origin_img_dir='./data/coco_ori/val2017')  # 完整的coco数据集的图片和标注的路径
coco.build('./data/coco/val2017', './data/coco/instances_val2017.json', 5000)  # 保存图片路径
