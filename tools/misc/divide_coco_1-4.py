...
coco.build('./data/mini_coco/mini_train2017', './data/mini_coco/mini_instances_train2017.json', 29568)  # 保存图片路径

coco = COCO('./data/coco/annotations/instances_val2017.json',
            origin_img_dir='./data/coco/val2017')  # 完整的coco数据集的图片和标注的路径
coco.build('./data/mini_coco/mini_val2017', './data/mini_coco/mini_instances_val2017.json', 1250)  # 保存图片路径
