...
if __name__ == '__main__':
    # xml标注文件夹
    xml_dir = '../../data/person_search/PRW_VOC/Annotations'
    # 训练数据的josn文件
    save_json_train = '../../data/person_search/PRW_COCO/train.json'
    # 验证数据的josn文件
    save_json_val = '../../data/person_search/PRW_COCO/val.json'
    # 验证数据的test文件
    save_json_test = '../../data/person_search/PRW_COCO/test.json'
